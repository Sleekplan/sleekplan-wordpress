...
// Admin view
function sp_view_admin_init() {
    // load admin view
    require_once( SP_PLUGIN_PATH . '/views/admin.inc.php' ) ;
}

// load scripts
function sp_enqueue_scripts( $hook ) {
